...
ggplot(DeltawLocGRDC, aes(y = MMD, x = rangeNDSSI)) + geom_point() 
ggplot(DeltawLocGRDC, aes(y = MMD, x = MaxMeanNDSSI)) + geom_point() 
```

```{r}
#plot mean of monthly means against NDSSI
GRDC1 <- ggplot(DeltawLocGRDC, aes(y = MMD, x = rangeNDSSI)) + geom_point() 
GRDC2 <- ggplot(DeltawLocGRDC, aes(y = MMD, x = MaxMeanNDSSI)) + geom_point() 
