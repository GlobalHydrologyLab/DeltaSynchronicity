...
ggplot(DeltasGRDC, aes(y = Range_Discharge, x = rangeNDSSI)) + geom_point() + scale_y_continuous(trans='log10')

#ggsave("GRDCNDSSI.pdf", width = 6, height = 4)

ggplot(DeltasGRDC, aes(y = Range_Discharge, x = MaxMeanNDSSI)) + geom_point() + scale_y_continuous(trans='log10')
```
